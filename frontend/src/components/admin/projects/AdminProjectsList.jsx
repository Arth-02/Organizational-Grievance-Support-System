...
const AdminProjectsList = () => {
  ...
  const handleToggleStatus = async (id, currentStatus) => {
    try {
      ...
      toast.success(currentStatus ? "Project deactivated" : "Project activated");
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Manage all projects across organizations</p>
      </div>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
                          onClick={() => handleToggleStatus(project._id, project.is_active)}
                          disabled={isUpdating}
                        >
                          {project.is_active ? (
                            <>
