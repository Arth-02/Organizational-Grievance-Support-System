...
const AuditLogDetails = () => {
  ...
  const getEntityColor = (entityType) => {
    const colors = {
      ...
      Role: "bg-orange-500/10 text-orange-600 dark:text-orange-400 border-orange-500/20",
      Grievance: "bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/20",
      Department: "bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 border-yellow-500/20",
    };
