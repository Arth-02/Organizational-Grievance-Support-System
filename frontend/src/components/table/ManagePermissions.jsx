    ...
    <Tooltip>
      <TooltipTrigger>
        <IconComponent
          ...
          size={30}
          className={`cursor-pointer p-[6px] rounded-md text-gray-800 dark:text-gray-200/50 hover:bg-primary/10 dark:hover:bg-secondary/30 hover:text-primary transition-all duration-200 ease-in ${
